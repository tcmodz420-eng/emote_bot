                    ...
                    try:
                        ...
                        if data2.hex().startswith('0500') and len(data2.hex()) > 1000:
                            try:
                                ...
                                message = f'[B][C]{get_random_color()}\n- WeLComE To Emote Bot ! \n\n{get_random_color()}- Commands : /play {xMsGFixinG('123456789')} {xMsGFixinG('909000001')}\n\n[00FF00]Dev : @{xMsGFixinG('godjexar')}'
                                P = await SEndMsG(0 , message , OwNer_UiD , OwNer_UiD , key , iv)
                                await SEndPacKeT(whisper_writer , online_writer , 'ChaT' , P)
                            except:
                                pass
...
async def MaiiiinE():
    Uid , Pw = '4242956680','44418560BFC6D83D99A58327C86D3B5475DBA02B3D80FA489CAA5F2E33924AFA'
